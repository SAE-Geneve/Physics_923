...
namespace crackitos_physics::math
{
    ...
    template <>
    FourVec4f FourVec4<crackitos_physics::commons::fp>::operator+(
        const FourVec4<crackitos_physics::commons::fp>& other) const
    {
        FourVec4<crackitos_physics::commons::fp> result;
