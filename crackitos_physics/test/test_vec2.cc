...
namespace crackitos_physics::math
{
    struct Vec2iOperatorFixture :
        public testing::TestWithParam<std::pair<Vec2<int>, Vec2<int>>>
    {
    };
    ...
    {
        auto [v1, v2] = GetParam();
        const auto result = Vec2<int>::Dot(v1, v2);
    ...
    /**
     * \brief Tests for Vec2 with crackitos_physics::commons::fps
     */
    struct Vec2fOperatorFixture :
        public testing::TestWithParam<std::pair<Vec2<crackitos_physics::commons::fp>, Vec2<crackitos_physics::commons::fp>>>
    {
    };
    ...
    {
        auto [v1, v2] = GetParam();
        const auto result = Vec2<crackitos_physics::commons::fp>::Dot(v1, v2);
    ...
    TEST_P(Vec2fOperatorFixture, Perpendicular)
    {
        ...
        const auto p1 = v1.Perpendicular();
        const auto p2 = v2.Perpendicular();
        EXPECT_FLOAT_EQ(math::Vec2<crackitos_physics::commons::fp>::Dot(v1, p1), 0);
        EXPECT_FLOAT_EQ(math::Vec2<crackitos_physics::commons::fp>::Dot(v2, p2), 0);

        const auto r1 = v1.Perpendicular2();
        const auto r2 = v2.Perpendicular2();
        EXPECT_FLOAT_EQ(math::Vec2<crackitos_physics::commons::fp>::Dot(v1, r1), 0);
        EXPECT_FLOAT_EQ(math::Vec2<crackitos_physics::commons::fp>::Dot(v2, r2), 0);
    }
    ...
    INSTANTIATE_TEST_SUITE_P(AllNumbers, Vec2fOperatorFixture,
                             testing::Values(
                                 ...
                                 std::pair{ math::Vec2<crackitos_physics::commons::fp>{}, math::Vec2<crackitos_physics::commons::fp>{} },
                                 std::pair{ math::Vec2{1.1f,5.0007f}, math::Vec2<crackitos_physics::commons::fp>{} },
                                 std::pair{ math::Vec2<crackitos_physics::commons::fp>{}, math::Vec2{1.93f,7.4f} }
                             )
    );
}