...
void CollisionContactListener::OnTriggerEnter(const physics::ColliderPair& pair)
{
  // std::cout << "Trigger Enter: " << pair.colliderA.id << " and " << pair.colliderB.id << "\n";
}
void CollisionContactListener::OnTriggerStay(const physics::ColliderPair& pair)
{
  // std::cout << "Trigger Stay: " << pair.colliderA.id << " and " << pair.colliderB.id << "\n";
}
void CollisionContactListener::OnTriggerExit(const physics::ColliderPair& pair)
{
...
void CollisionContactListener::OnCollisionStay(const physics::ColliderPair& pair)
{
  // std::cout << "Collision Stay: " << pair.colliderA.id << " and " << pair.colliderB.id << "\n";
}
void CollisionContactListener::OnCollisionExit(const physics::ColliderPair& pair)
{
