...
namespace crackitos_physics::samples
{
    ...
    //Spawn Random Shapes
    void TestingSystem::SpawnShape(const crackitos_core::math::Vec2f& pos, crackitos_core::math::ShapeType type)
    {
    ...
    void TestingSystem::SetGravity(const crackitos_core::math::Vec2f& gravity)
    {
