...
namespace physics923::math
{
    ...
    {
        std::array<Vec3<physics923::commons::fp>, 4> a_arr = {
            Vec3<physics923::commons::fp>{1.0f, 2.0f, 3.0f}, Vec3<physics923::commons::fp>{4.0f, 5.0f, 6.0f}, Vec3<physics923::commons::fp>{7.0f, 8.0f, 9.0f},
            Vec3<physics923::commons::fp>{10.0f, 11.0f, 12.0f}
        };
        std::array<Vec3<physics923::commons::fp>, 4> b_arr = {
            Vec3<physics923::commons::fp>{13.0f, 14.0f, 15.0f}, Vec3<physics923::commons::fp>{16.0f, 17.0f, 18.0f}, Vec3<physics923::commons::fp>{19.0f, 20.0f, 21.0f},
            Vec3<physics923::commons::fp>{22.0f, 23.0f, 24.0f}
        };

        FourVec3<physics923::commons::fp> a(a_arr);
        FourVec3<physics923::commons::fp> b(b_arr);
        FourVec3<physics923::commons::fp> result = a + b;
    ...
    {
        std::array<Vec3<physics923::commons::fp>, 4> a_arr = {
            Vec3<physics923::commons::fp>{10.0f, 20.0f, 30.0f}, Vec3<physics923::commons::fp>{40.0f, 50.0f, 60.0f}, Vec3<physics923::commons::fp>{70.0f, 80.0f, 90.0f},
            Vec3<physics923::commons::fp>{100.0f, 110.0f, 120.0f}
        };
        std::array<Vec3<physics923::commons::fp>, 4> b_arr = {
            Vec3<physics923::commons::fp>{1.0f, 2.0f, 3.0f}, Vec3<physics923::commons::fp>{4.0f, 5.0f, 6.0f}, Vec3<physics923::commons::fp>{7.0f, 8.0f, 9.0f},
            Vec3<physics923::commons::fp>{10.0f, 11.0f, 12.0f}
    ...
    TEST(FourVec3Test, Negation)
    {
        ...
        FourVec3<physics923::commons::fp> a(a_arr);
        FourVec3<physics923::commons::fp> result = -a;
    ...
    TEST(FourVec3Test, ScalarMultiplication)
    {
        ...
        FourVec3<physics923::commons::fp> a(a_arr);
        FourVec3<physics923::commons::fp> result = a * 2.0f;
    ...
    TEST(FourVec3Test, ScalarDivision)
    {
        ...
        FourVec3<physics923::commons::fp> a(a_arr);
        FourVec3<physics923::commons::fp> result = a / 10.0f;
    ...
    {
        std::array<Vec3<physics923::commons::fp>, 4> a_arr = {
            Vec3<physics923::commons::fp>{1.0f, 2.0f, 3.0f},
            Vec3<physics923::commons::fp>{4.0f, 5.0f, 6.0f},
            Vec3<physics923::commons::fp>{7.0f, 8.0f, 9.0f},
            Vec3<physics923::commons::fp>{10.0f, 11.0f, 12.0f}
        };
    ...
    {
        std::array<Vec3<physics923::commons::fp>, 4> a_arr = {
            Vec3<physics923::commons::fp>{3.0f, 0.0f, 0.0f},
            Vec3<physics923::commons::fp>{0.0f, 4.0f, 0.0f},
            Vec3<physics923::commons::fp>{0.0f, 0.0f, 5.0f},
            Vec3<physics923::commons::fp>{1.0f, 2.0f, 2.0f}
        };

        FourVec3<physics923::commons::fp> a(a_arr);
        FourVec3<physics923::commons::fp> result = a.Normalize();
